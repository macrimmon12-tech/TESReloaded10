...
public:
	...
	struct VolumetricFogStruct {
		...
		D3DXVECTOR4		Global;          // x: Amount, y: unused, z: MoonVisibility, w: MinDensityFloor
		...
		D3DXVECTOR4		NightTint;       // xyz: multiplicative night fog color tint, w: NightAmbientStrength
