// Skin Shader for skin with sunshadow whith 1 light
//
// Parameters:
...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    // sampling shadow map (unused by NVR)
    //float t1 = tex2D(ShadowMaskMap, IN.texcoord_7.zw);			
    //float3 t0 = tex2D(ShadowMap, IN.texcoord_7.xy);			
...
#if HAIR_SHADER_DIAG
    OUT.color_0.rgb = float3(0.0f, 0.6f, 1.0f);          // sky blue (SKIN2003)
    OUT.color_0.a = 1.0f;
#endif
