// Skin with sun shadow and one point light
//
// Parameters:
...
struct VS_INPUT {
    ...
    float3 texcoord_1 : TEXCOORD1_centroid;         // sun light direction in tangent space
    ...
    float4 texcoord_7 : TEXCOORD7;                  // shadow map UVs
};
...
VS_OUTPUT main(VS_INPUT IN) {
    ...
    float3 sunColor = PSLightColor[1].rgb * shadowAttenuation;
